...
const PrivacyWindow = ({ handleCloseModal }) => {
  return (
    <Wrapper>
      <HelpWrapper>
        ...
        <Contents>
          ...
          第2条（個人情報の収集方法）
          <br />
          当団体は、ユーザーが利用登録をする際に氏名、生年月日、住所、電話番号、メールアドレスなどの個人情報をお尋ねすることがあります。また、ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を、当団体の提携先（情報提供元、広告主、広告配信先などを含みます。以下、｢提携先｣といいます。）などから収集することがあります。
          <br />
          <br />
          第3条（個人情報を収集・利用する目的）
          <br />
